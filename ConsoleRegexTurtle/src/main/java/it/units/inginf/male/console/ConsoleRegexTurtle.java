...
public class ConsoleRegexTurtle {
    ...
    public static void main(String[] args) throws IOException {
        ...
        simpleConfiguration.datasetName = "/home/sam/projects/RegexGenerator/ConsoleRegexTurtle/testdataset/reduced.json"; // -d
        ...
        String outJson = results.getBestSolution().toJson();
        System.out.println(outJson);
        FileWriter fw = new FileWriter("generated.json");
        fw.write(outJson);
        fw.close();
